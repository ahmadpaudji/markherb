         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <h3 class="page-title">
                     FAQ <small> Configure Your Frequently Asked Question Page </small>
                  </h3>
                  <ul class="breadcrumb">
                    <li>
                        <i class="icon-home"></i>
                     ...
                     <div class="portlet-title">
                      ...
                      <div class="portlet-body form">
                        <?php if(isset($confirm)) : ?>
                           ...
                           <?php endif; ?>
                        <form id="profile-form" class="form-horizontal" action="<?php echo base_url(); ?>admin/question" method="POST">
                          <div class="control-group">
                              <label class="control-label">Web Profile</label>
                              <div class="controls">
                                 <textarea class="span12 ckeditor m-wrap" id="profile" name="question" rows="6" required>
                                    <?php echo $isi->isi; ?>
                                 </textarea>
                              </div>
                           </div>
